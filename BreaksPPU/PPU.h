...
enum {
    ...
    PPU_CTRL_FNT, PPU_CTRL_FAT, PPU_CTRL_FTA, PPU_CTRL_FTB, PPU_CTRL_nFO,    // memory fetch orders
    PPU_CTRL_PICTURE, PPU_CTRL_BURST, PPU_CTRL_SYNC,      // videout controls
    PPU_CTRL_nBPORCH,        // back porch (internal)
    PPU_CTRL_nFPORCH,        // front porch (internal)
    PPU_CTRL_nINT,          // /INT

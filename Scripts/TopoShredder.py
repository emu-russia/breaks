...
def PpuShredder (FusedTopo):
	...
	CropImage (FusedTopo, imgstore + "oam_col_decoder", [8369, 4329, 3189, 471] )
	CropImage (FusedTopo, imgstore + "oam_row_decoder", [7171, 872, 1125, 528] )
	CropImage (FusedTopo, imgstore + "oam_row_outputs1", [8355, 2020, 349, 614] )
	CropImage (FusedTopo, imgstore + "oam_row_outputs2", [8356, 3852, 349, 477] )
	# OAM Eval
	...
	# PAR
	CropImage (FusedTopo, imgstore + "ppu_par_control", [8298, 7929, 409, 579] )
	CropImage (FusedTopo, imgstore + "ppu_par_counters_control_bot", [7720, 8329, 1104, 882] )
	CropImage (FusedTopo, imgstore + "ppu_par_counters_control_top", [7638, 7535, 628, 1013] )
	CropImage (FusedTopo, imgstore + "ppu_par_counters_fv", [8384, 8417, 488, 787] )
	CropImage (FusedTopo, imgstore + "ppu_par_counters_nt", [8880, 8398, 407, 796] )
	CropImage (FusedTopo, imgstore + "ppu_par_counters_th", [10168, 8452, 881, 763] )
	CropImage (FusedTopo, imgstore + "ppu_par_counters_tv", [9319, 8396, 900, 824] )

...
| BG colour / pattern shifters — `bgcol_test.v` (`bgcol_test.bat`) | TEST PASS (467) | ![bgcol_test](waves/bgcol_test.png) | Pattern load (F_TA/F_TB) + per-pixel shift out of the two bitplanes, fine-H select, attribute bits, /CLPB clip. |

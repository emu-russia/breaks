...
static GraphTrigger trigs[] = {
    ...
    { "_IR0", &_IR[0], 4459, 569 + 0*16 },
    { "_IR1", &_IR[1], 4459, 569 + 1*16 },
    { "_IR2", &_IR[2], 4459, 569 + 2*16 },
    { "_IR3", &_IR[3], 4459, 569 + 3*16 },
    { "_IR4", &_IR[4], 4459, 569 + 4*16 },
    { "_IR5", &_IR[5], 4459, 569 + 5*16 },
    { "_IR6", &_IR[6], 4459, 569 + 6*16 },
    { "_IR7", &_IR[7], 4459, 569 + 7*16 },

...
- `/out`: выход одного разряда счетчика (инвертированное значение). Используется в схемах оптимизации переноса.
...
Счетчики включают в свой состав следующие небольшие схемы:

...
:warning: Под "спрайтом #0" имеется ввиду не нулевой индекс спрайта в OAM, а нулевой лейн в OAM FIFO. Технически не обязательно чтобы в лейн 0 OAM FIFO попадал спрайт с индексом 0 из OAM, но обычно разработчики помещают именно в OAM\[0\] специальный спрайт, для обработки Sprite0 Hit, поэтому особого значения этому придавать не нужно.

...
Сигнал /RD является комплементарным сигналу /WR (они не могут оба принимать значение 0, но могут быть одноврменно 1, когда интерфейс VRAM не используется).
...
Сигнал /WR является комплементарным сигналу /RD (они не могут оба принимать значение 0, но могут быть одноврменно 1, когда интерфейс VRAM не используется).

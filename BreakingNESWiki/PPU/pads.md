...
{{:ppu:pasted:20181128-101155.png?600}}
...
{{:ppu:pasted:20181128-101050.png?600}}
...
{{:ppu:pasted:20181128-100949.png?600}}
...
{{:ppu:pasted:20181128-100801.png?600}}
...
{{:ppu:pasted:20181128-101334.png?600}}
...
{{:ppu:pasted:20181128-101650.png?600}}
...
{{:ppu:pasted:20181128-101736.png?600}}
...
{{:ppu:pasted:20181128-101819.png?600}}
...
{{:ppu:pasted:20181128-101848.png?600}}
...
{{:ppu:pasted:20181128-100636.png?600}}

Разработчики предусмотрели взаимодействие нескольких PPU. Схема взаимодействия немудреная и выглядит следующим образом:
  * Внутри PPU находится [[ppu:mux|мультиплексор]], который по выбору может направлять "картинку" как на экран, так и на внешние контакты EXT
...
Все остальные схемы тактируются посредством [[ppu:pclk|Pixel Clock]]
...
{{:ppu:pasted:20181128-101916.png?600}}

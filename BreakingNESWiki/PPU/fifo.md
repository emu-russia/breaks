...
|/Tx|Результат работы схемы H.INV, входное значение для загрузки в спаренный регистра сдвига (в инверсной логике)|
|#0/H|Производный сигнал от 0/HPOS|
|#x/EN|0: Лейн активен. Каждый лейн может активироваться индвидуально своим #EN сигналом.|
|**Выходные сигналы**||
|/SH2|Также используется в Data Reader|
|/SPR0HIT|Для определения события `Sprite 0 Hit`.|
|#Z/COL0, #Z/COL1, Z/COL2, Z/COL3, #Z/PRIO|Результаты работы FIFO для мультиплексора (MUX)|

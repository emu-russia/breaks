...
|SPR_OV|Cпрайтов на текущей строке больше 8 или главный счётчик OAM переполнен, копирование прекращено|
...
|/SPR0_EV|0: Cпрайт "0" найден на текущей строке|
...
|Счётчик OAM|Разрядность (бит)|Модуль счета|Инициализация|Сравнение (поиск)|Сравнение (копирование)|Выборка спрайтов из Temp ОАМ в FIFO|
|---|---|---|---|---|---|---|
|OAM|8|+1 / +4|Не работает|Работает, режим +4|Работает, режим +1|Не работает|
|Temp OAM|5|+1|Работает|Не работает|Работает|Работает|

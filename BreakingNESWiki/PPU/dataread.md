...
> а то что раньше называлось PAR - это на самом деле не показанный в патенте адресный мультиплексор (который мы решили назвать не хитро - PPU Address Mux, PAMUX).

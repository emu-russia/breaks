...
Предназначен для получения двух комплементарных управляющих линий /RD и /WR из входного контакта интерфейса CPU R/W.
...
Как известно, 2 последовательные записи в регистр $2005 или $2006 на самом деле записывают значение в две старшие или младшие половинки внутреннего 16-разрядного регистра (FV/FH).

...
Официальное название регистров (как бы это странно не выглядело сейчас): CTLR0 и CTLR1 (не опечатка).
...
|CLPO|Regs|FIFO|1: Отсечение спрайтов. Финальный сигнал для схемы Obj FIFO|

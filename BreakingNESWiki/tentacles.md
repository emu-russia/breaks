...
|x/EN|#x/EN (инверсная полярность), Obj FIFO|
|x/COL0, x/COL1|#x/COL0, #x/COL1 (инверсная полярность), Obj FIFO|
|Tx|/Tx (инверсная полярность), Obj FIFO|
|0/H|#0/H (инверсная полярность), Obj FIFO|
|0/FIFO|PD/FIFO|
|M4_OVZ|COPY_OVF|
|DDD|COPY_STEP|
|/I2|DO_COPY|

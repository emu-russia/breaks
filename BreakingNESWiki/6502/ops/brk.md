...
Феномен: Все части процессора "сходят с ума", но чудесным образом в результате всех операции процессор делает запись 0x00 по адресу 0x0000. Эта запись дискардится, т.к. PHI1 (процессор "слушает").

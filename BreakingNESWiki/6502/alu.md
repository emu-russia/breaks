...
:warning: По прошествии времени вскрылось, что FET где применяются команды SB/DB, SB/ADH, 0/ADH0, 0/ADH17 удобнее сделать частью схемы [Bus Multiplexer](busmux.md)

...
С аппаратной точки зрения рандомная логика - это "хенд-мэйд" продукт инженеров [[:mos|MOS]]. Глядя на схему топологии кристалла, где содержится эта логика, становится дурно неподготовленному человеку :-)

{{6502:random_logic_preview_topo.jpg?600}}
...
{{6502:random_logic_early.jpg?600}}
...
Ниже вы можете ознакомиться со всеми функциональными блоками рандомной логики:\\
  * [[6502:random:regs_control|Управление регистрами]]
  * [[6502:random:alu_control|Управление АЛУ]]
  * [[6502:random:pc_control|Управление program counter-ом]]
  * [[6502:random:bus_control|Управление шинами]]
  * [[6502:random:dispatch|Логика исполнения (dispatch)]]
  * [[6502:random:flags_control|Логика установки флагов]]
  * [[6502:random:flags|Флаги]]
  * [[6502:random:branch_logic|Логика условных переходов]]

==== Принцип работы ====

В целом работа логики довольно комплексная :
  ...
  * В зависимости от результатов декодирования схемы управления: регистрами, АЛУ, PC и шинами выдают наружу в нижнюю часть специальные [[6502:control|управляющие команды]]
...
[[6502:phi1|Начало работы процессора]]

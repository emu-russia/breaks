...
- S: указатель стека. Регистр S отличается особенным устройством: у него есть входная защёлка и выходная. При этом загрузка значения на входную защёлку и выход значения с выходной защёлки может происходить одновременно.
...
- PCHS/PCLS: вспомогательные регистры счётчика инструкций (S скорее всего означает "Shadow")
...
- ADH/ADL: шина адреса
- SB: Side bus, шина для обмена регистрами

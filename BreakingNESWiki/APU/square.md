...
APU содержит два тональных генератора прямогольных сигналов ("меандр"). Схемы зеркально повторяют друг друга, поэтому рассмотрим только тональный генератор первого прямоугольного канала (SQUARE 1).

...
Скважность M2 сделана таким образом, что верхний уровень M2 становится активным на 1.5 CLK (3 полуцикла) раньше верхнего уровня PHI2 ядра. Таким образом внешние устройства начинают свою активность на шине раньше встроенного ядра 6502. При установке режима чтения внешние устройства могут "заранее" поместить данные для процессора. При установке режима записи внешние устройства могут "заранее" освободить шину для процессора.

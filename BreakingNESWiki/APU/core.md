...
Сигналы на самом деле идентичны, но видимо предполагалось разделить адресное пространство регистров для чтения и для записи. Либо заложили эту возможность на всякий случай.
...
:warning: Выбор адресного пространства регистров APU производится по значению адресной шины CPU (`CPU_Ax`). Но выбор регистра производится по значению адреса, который хранится на адресной защелке DMA-контроллера (cигналы A0-A4).

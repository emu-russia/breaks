...
- Выходной регистр $4011 представляет собой реверсивный счетчик, который считает вниз, если следующий разряд битстрима равен 1 или вверх, если следующий разряд битстрима равен 0

...
|#TRESX=0|The circuit that forms #TRESX includes a latch whose value is not yet defined (PHI2). And through the inverter and NOR - #TRESX as a result takes the value 0.|
|/TWOCYCLE=1|PD=0x00|
